...
import { Mail, MapPin, Phone, Github, Linkedin, Twitter, Code2, Clock, Globe } from 'lucide-react';
  ...
  return (
    <div className="min-h-screen bg-[#0a0a0a] text-gray-100 font-poppins overflow-hidden">
          ...
          >
            ...
            <form className="space-y-8">
              <div className="space-y-4">
                <label className="block text-gray-300 text-lg">Full Name</label>
                <input 
                  type="text" 
              ...
              <div className="space-y-4">
                <label className="block text-gray-300 text-lg">Project Details</label>
                <textarea 
                  rows="6"
                  className="w-full bg-[#1a1a1a] border-2 border-gray-800/50 rounded-xl p-5 focus:border-cyan-400/40 focus:ring-2 focus:ring-cyan-400/20 transition-all"
              ...
              <div className="space-y-8">
                <div className="flex items-start gap-6">
                  ...
                  <div>
                    ...
                    <p className="text-gray-400">Tech Valley District</p>
                    <p className="text-gray-400">Innovation Road, Block C</p>
                ...
                <div className="flex items-start gap-6">
                  ...
                  <div>
                    ...
                    <p className="text-gray-400">contact@codesneakers.com</p>
                    <p className="text-gray-400">careers@codesneakers.com</p>
                  </div>
                </div>
              </div>
            </motion.div>
            ...
            >
              ...
              <div className="flex gap-6">
                {[
                  ...
                  { icon: <Linkedin />, color: 'hover:text-blue-400', link: 'https://linkedin.com' },
      ...
      <div className="relative h-[600px] bg-gradient-to-b from-[#0a0a0a] to-[#111111]">
        ...
        <iframe
          src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3502.356259926202!2d77.31626631508295!3d28.62628098242495!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x390ce5456faaa9ab%3A0x3b433f2f5af0c2e2!2sIndia%20Gate!5e0!3m2!1sen!2sin!4v1658931871272!5m2!1sen!2sin"
